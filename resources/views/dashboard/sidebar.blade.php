      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('view-gatepass') }}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>View All Request</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('create-gatepass') }}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{ route('viewCreateAccount') }}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Create Accounts</p>
              </a>
            </li>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('view-site') }}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>{{ __('View All Site') }}</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('view-create-site') }}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>{{ __('Add new Site') }}</p>
              </a>
            </li>
